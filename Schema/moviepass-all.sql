...
ALTER TABLE `Funciones`
  MODIFY `id_funcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

ALTER TABLE `Peliculas`
  MODIFY `id_pelicula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

ALTER TABLE `PeliculasXGeneros`
  MODIFY `id_peliculasxgeneros` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=249;
