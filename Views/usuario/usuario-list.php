...
<div class="container-fluid mb-4">
    <div class="col-sm-12 col-md-10 offset-sm-0 offset-md-1 bg-dark rounded shadow p-2">
        ...
        <h2 class="col-sm-12 col-md-6 pb-2 text-light">Lista de usuarios</h2>
        <table class="table table-striped table-responsive-md text-light align-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo FRONT_ROOT ?>Usuario/ShowProfileView/<?php echo $usuario->getId(); ?>" class="text-light"><img src="<?php if($usuario->getFacebookId() == null) echo FRONT_ROOT; ?><?php echo $usuario->getImage() ?>" height="35" class="rounded-circle z-depth-0 mr-2" alt="avatar image"><b><?php echo $usuario->getNombre(); ?> <?php echo $usuario->getApellido(); ?></b></a></td>
