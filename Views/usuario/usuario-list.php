        ...
        <table class="table table-striped table-responsive-md text-light align-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo FRONT_ROOT ?>Usuario/ShowProfileView/<?php echo $usuario->getId(); ?>" class="text-light"><img src="<?php echo FRONT_ROOT.$usuario->getImage() ?>" height="35" class="rounded-circle z-depth-0 mr-2" alt="avatar image"><b><?php echo $usuario->getNombre(); ?> <?php echo $usuario->getApellido(); ?></b></a></td>
