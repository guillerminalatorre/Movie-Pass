...
<div class="container mb-4">
    <div class="row">
        <div class="col-sm bg-light rounded p-4 text-center mr-4">
            ...
            <div><a class="btn btn-secondary mb-4" href="<?php echo FRONT_ROOT ?>Cine/ShowListView" role="button">Ver lista de cines</a></div>
            ...
            <!-- Modificar cine -->
            <a href="<?php echo FRONT_ROOT ?>Cine/ShowEditView/<?php echo $cine->getId();?>" class="btn btn-warning btn-md mt-2" role="button">Modificar</a>
            
            <!-- Eliminar cuenta -->
            <a onclick = "if(borrarCine('<?php echo $cine->getNombre(); ?>')) href='<?php echo FRONT_ROOT ?>Cine/eliminarCine/<?php echo $cine->getId(); ?>' ;" class="btn btn-danger btn-md mt-2" role="button">Eliminar</a>
