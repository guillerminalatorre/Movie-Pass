<ul class="navbar-nav ml-auto nav-flex-icons">
    <li class="nav-item avatar dropdown">
        ...
        <?php echo $_SESSION["loggedUser"]->getNombre() . " " . $_SESSION["loggedUser"]->getApellido(); ?><img src="<?php if($_SESSION["loggedUser"]->getFacebookId() == null) echo FRONT_ROOT; ?><?php echo $_SESSION["loggedUser"]->getImage() ?>" height="30" class="rounded-circle z-depth-0 ml-2" alt="avatar image">
        </a>
        <div class="dropdown-menu dropdown-menu-lg-right dropdown-secondary" aria-labelledby="navbarDropdownMenu">
