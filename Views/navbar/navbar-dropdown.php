<ul class="navbar-nav ml-auto nav-flex-icons">
    <li class="nav-item avatar dropdown">
        ...
        <?php echo $_SESSION["loggedUser"]->getNombre() . " " . $_SESSION["loggedUser"]->getApellido(); ?><img src="<?php echo FRONT_ROOT.$_SESSION["loggedUser"]->getImage() ?>" height="30" class="rounded-circle z-depth-0 ml-2" alt="avatar image">
        </a>
