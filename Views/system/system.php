            ...
            <div class="row text-center">
                ...
                <div class="col-xl-3 col-sm-6 mb-5">
                    <div class="bg-white rounded shadow-sm py-5 px-4">
                        ...
                        <a href="<?php echo FRONT_ROOT ?>Usuario/ShowListView" class="btn btn-info btn-md mt-2" role="button">Lista de usuarios</a>
                    </div>
                </div><!-- End -->
                ...
                <div class="col-xl-3 col-sm-6 mb-5">
                    <div class="bg-white rounded shadow-sm py-5 px-4">
                        ...
                        <a href="<?php echo FRONT_ROOT ?>Cine/ShowListView" class="btn btn-info btn-md mt-2" role="button">Lista de cines</a>
                    </div>
                </div><!-- End -->
                ...
                <div class="col-xl-3 col-sm-6 mb-5">
                    <div class="bg-white rounded shadow-sm py-5 px-4">
                        ...
                        <a href="<?php echo FRONT_ROOT ?>Funcion/ShowListView" class="btn btn-info btn-md mt-2" role="button">Lista de funciones</a>
                    </div>
                </div><!-- End -->
            </div>
        </div>
