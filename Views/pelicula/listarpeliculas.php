...
<div class="container-fluid mb-4">
  <div class="col-sm-12 col-lg-10 offset-sm-0 offset-lg-1 bg-dark rounded shadow mb-4">
    ...
    <div id="multi-item-example" class="carousel slide carousel-multi-item" data-ride="carousel">
      ...
      <a class="carousel-control-prev" href="#multi-item-example" role="button" data-slide="prev">
        <i class="fas fa-chevron-left text-dark fa-8x"></i>
        <span class="sr-only">Previous</span>
      </a>
      <a class="carousel-control-next" href="#multi-item-example" role="button" data-slide="next">
        <i class="fas fa-chevron-right text-dark fa-8x"></i>
  ...
  <div class="col-sm-12 col-lg-10 offset-sm-0 offset-lg-1 bg-dark rounded shadow">
    <div class="row">
      <?php
      if (!empty($peliculaList)) 
      {
